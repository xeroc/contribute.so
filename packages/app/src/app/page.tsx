    ...
    <Layout>
      ...
      <section className="pt-24 pb-12 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-2xl text-default-700 mb-8 max-w-2xl mx-auto">
            ...
            , backed by Tributary's transparent protocol.
          </p>
          <CTAButton />
        </div>
      </section>
      ...
      {/* Tributary Protocol */}
      <section id="tributary" className="py-16 px-4 bg-content1/50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-8">
            Powered by <a href="https://tributary.so">Tributary Protocol</a>
          </h2>
          <p className="text-lg text-default-700 mb-6 text-center">
          ...
          <div className="bg-content2 rounded-lg p-6 font-mono text-sm text-left mb-6">
            <div className="text-primary">// How Tributary Works</div>
            <div className="text-success">const tributaryFlow = &#123;</div>
            <div className="ml-4 text-warning">delegate: "🎓 Smart contract approved for ATA withdrawals",</div>
            <div className="ml-4 text-warning">policy: "🔧 Configurable recurring payment rules",</div>
            <div className="ml-4 text-warning">execution: "🤖 Automated, transparent on-chain payments",</div>
            <div className="ml-4 text-warning">transparency: "🔒 Immutable blockchain records"</div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="flex items-start space-x-4">
              <div className="bg-primary text-foreground rounded-full w-8 h-8 flex items-center justify-center font-bold font-mono">
                1
              </div>
              <div>
      ...
      {/* Features */}
      <section id="features" className="py-16 px-4 bg-content1/50">
