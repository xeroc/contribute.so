    ...
    return (
      <Layout>
        <div className="flex h-full flex-col items-center justify-center">
          <div className="container flex flex-col items-center justify-center gap-12 px-4 py-16 max-w-2xl">
            <button
              className="text-default-600 hover:text-default-700 text-sm underline self-start mb-4"
            ...
            <div className="w-full space-y-4">
              <Button
                ...
                className="w-full bg-gray-100 hover:bg-gray-200 p-6 h-auto"
                size="lg"
              >
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-lg flex items-center justify-center border-1">
